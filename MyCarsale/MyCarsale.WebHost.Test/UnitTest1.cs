...
namespace MyCarsale.WebHost.Test
{
    ...
    public class UnitTest1
    {
            ...
            public void Initialise_Me()
        {
                    ...
                    { 
                        CustomerDetail = new CustomerDto
                        {
                            ...
                            CustomerAddress = new AddressDto
                            {
                                ...
                                AreaLocation = new LocationDto { city = new CityDto { CityId = 1 } },
                                Postcode = "2545"
                            }
                        },
                        CarEnquiryDetail = new List<CarDto> { new CarDto { ID = 1 }, new CarDto { ID = 2 } },
            ...
            #region CarInfo
                _carinfo = new CarInfoDto { PriceRange = new PriceDto { PriceRange = new RangeDto { minvalue = 10000, maxvalue = 50000 } } };
            #endregion
        ...
        public void Post_AddCar()
        {
            ...
            var cs = carctl.Post(_car, _carcol);
